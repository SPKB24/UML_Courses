...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/assignment_6.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/assignment_6 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/CreateDOMDocument.o: CreateDOMDocument.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CreateDOMDocument.o CreateDOMDocument.cpp

${OBJECTDIR}/DOMPrintErrorHandler.o: DOMPrintErrorHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DOMPrintErrorHandler.o DOMPrintErrorHandler.cpp

${OBJECTDIR}/DOMPrintFilter.o: DOMPrintFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DOMPrintFilter.o DOMPrintFilter.cpp

${OBJECTDIR}/DOMTreeErrorReporter.o: DOMTreeErrorReporter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DOMTreeErrorReporter.o DOMTreeErrorReporter.cpp
