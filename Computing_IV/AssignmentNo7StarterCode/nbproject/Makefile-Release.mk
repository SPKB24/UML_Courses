...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/assignmentno7startercode.exe
...
${OBJECTDIR}/CreateDOMDocument.o: CreateDOMDocument.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CreateDOMDocument.o CreateDOMDocument.cpp

${OBJECTDIR}/DOMPrintErrorHandler.o: DOMPrintErrorHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DOMPrintErrorHandler.o DOMPrintErrorHandler.cpp

${OBJECTDIR}/DOMPrintFilter.o: DOMPrintFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DOMPrintFilter.o DOMPrintFilter.cpp

${OBJECTDIR}/DOMTreeErrorReporter.o: DOMTreeErrorReporter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DOMTreeErrorReporter.o DOMTreeErrorReporter.cpp

${OBJECTDIR}/jmhUtilities.o: jmhUtilities.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jmhUtilities.o jmhUtilities.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/assignmentno7startercode.exe
